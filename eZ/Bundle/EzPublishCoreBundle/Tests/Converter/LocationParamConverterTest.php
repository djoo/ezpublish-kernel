...
class LocationParamConverterTest extends AbstractParamConverterTest
{
    ...
    {
        $config = $this->createConfiguration( LocationParamConverter::LOCATION_CLASS );
    ...
    public function testApplyLocation()
    {
        ...
        $request = new Request( [], [], [LocationParamConverter::LOCATION_ID => $id] );
        $config = $this->createConfiguration( LocationParamConverter::LOCATION_CLASS, 'location' );

        $this->converter->apply( $request, $config );

        $this->assertInstanceOf( LocationParamConverter::LOCATION_CLASS, $request->attributes->get( 'location' ) );
    }
    ...
    {
        $request = new Request( [], [], [LocationParamConverter::LOCATION_ID => null] );
        $config = $this->createConfiguration( LocationParamConverter::LOCATION_CLASS, 'location' );
